...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen flex">
            ...
            {/* Right Side - Image */}
            <div className="hidden lg:block lg:flex-1 bg-gradient-to-br from-indigo-600 to-purple-700 flex items-center justify-center">
                <div className="text-center text-white">
                    <svg className="h-32 w-32 mx-auto mb-6 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                    <p className="text-sm opacity-75">Your Library.jpg image will appear here<br/>when implemented in your project</p>
                </div>
            </div>
        </div>
    );
